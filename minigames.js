...
async function minigames(msg, aux, bot) {
    ...
    if (msg.content.toLowerCase() === "->yt") {
        if (commandsMinigames[0].onlyIn.find(element => element == msg.guild.id)){
        ...
        if (commandsMinigames[1].onlyIn.find(element => element == msg.guild.id)){
            const voiceChannel = msg.member.voice.channel;
            if (!voiceChannel){
                msg.reply("Entra em um canal primeiro, oh seu animal!")
        ...
        if (commandsMinigames[2].onlyIn.find(element => element == msg.guild.id)){
            const voiceChannel = msg.member.voice.channel;
            if (!voiceChannel){
                msg.reply("Entra em um canal primeiro, oh seu animal!")
        ...
        if (commandsMinigames[3].onlyIn.find(element => element == msg.guild.id)){
            const voiceChannel = msg.member.voice.channel;
            if (!voiceChannel){
                msg.reply("Entra em um canal primeiro, oh seu animal!")
